...
class USSegmentation:
    def __init__(self, checkpoint_path:Path or str):
        ...
        sam, _ = sam_model_registry['vit_h'](image_size=self.image_size,
    ...
    def load_model(self):
        ...
        optimum_weights = [
            'model_weights_h/fold0/epoch_6.pth',
            'model_weights_h/fold1/epoch_5.pth',
            'model_weights_h/fold2/epoch_4.pth',
            'model_weights_h/fold3/epoch_17.pth',
            'model_weights_h/fold4/epoch_23.pth',
        ]
